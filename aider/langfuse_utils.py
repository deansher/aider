...
This module provides a clean interface for all Langfuse operations.
...
class LangfuseTracer:
    ...
    def __init__(
        ...
        Args:
            public_key: Optional Langfuse public key.
                If not provided, will use LANGFUSE_PUBLIC_KEY env var.
            secret_key: Optional Langfuse secret key.
                If not provided, will use LANGFUSE_SECRET_KEY env var.
    ...
    def trace_generation(
        self, messages: list, model: str, stream: bool = False, name: str = "llm-call"
    ) -> Iterator[Any]:
        ...
        generation = trace.generation(name=name, model=model, input=messages)
    ...
    @contextlib.contextmanager
    def trace(self, name: str, **kwargs) -> Iterator[Any]:
